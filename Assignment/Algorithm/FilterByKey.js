 ...
 */
function functionalFilterByKey(items, searchFor, searchBy, searchMeth) {
    return items.filter((item) => (String(item[searchBy].toLowerCase()))[searchMeth](searchFor.toLowerCase()))
}

console.log(functionalFilterByKey(people, "aw", "lastName", "includes"))
console.log(functionalFilterByKey(people, searchFor1, searchBy1, "startsWith"))
console.log(functionalFilterByKey(people, searchFor2, searchBy2, "startsWith"))
console.log(functionalFilterByKey(people, searchFor3, searchBy3, "startsWith"))
